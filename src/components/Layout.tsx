...
const APP_TITLE = 'Straßenschadensmanagement';

const navigation = [
  { name: 'Übersicht', href: '/', icon: LayoutDashboard },
  { name: 'Straßenverzeichnis', href: '/straßenverzeichnis', icon: FileText },
  { name: 'Schnellmeldung', href: '/schnellmeldung', icon: FileText },
  { name: 'Schadensmeldungen', href: '/schadensmeldungen', icon: FileText },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="lg:pl-72">
        ...
        <main className="p-3 sm:p-6 lg:p-8 max-w-screen-2xl">
          <Outlet />
        </main>
      </div>
